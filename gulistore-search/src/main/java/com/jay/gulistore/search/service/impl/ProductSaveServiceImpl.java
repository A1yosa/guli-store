...
import com.jay.gulistore.search.service.ProductSaveService;
...
public class ProductSaveServiceImpl implements ProductSaveService {
    ...
    public boolean productStatusUp(List<SkuEsModel> skuEsModels) throws IOException {
        ...
        BulkResponse bulk = restHighLevelClient.bulk(bulkRequest, GulistoreElasticSearchConfig.COMMON_OPTIONS);
        //TODO 如果批量错误
