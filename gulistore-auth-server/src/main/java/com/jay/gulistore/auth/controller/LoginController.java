package com.jay.gulistore.auth.controller;
...
import com.jay.gulistore.auth.feign.MemberFeignService;
...
import com.jay.gulistore.auth.feign.ThirdPartFeignService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.data.redis.core.StringRedisTemplate;
...
public class LoginController {
    ...
    public String loginPage(HttpSession session){
        ...
        return "redirect:http://sukestore.com";
    }
    ...
    public String login(UserLoginVo userLoginVo, // from表单里带过来的
        ...
        if(r.getCode() == 0){
            ...
            return "redirect:http://auth.sukestore.com/login.html";
        }
    }
    ...
    public R sendCode(@RequestParam("phone") String phone){
        ...
        // 缓存验证码
        redisTemplate.opsForValue().set(AuthServerConstant.SMS_CODE_CACHE_PREFIX + phone, redis_code , 10, TimeUnit.MINUTES);
        try {// 调用第三方短信服务
    ...
    public String register(@Valid UserRegisterVo userRegisterVo,
        ...
        if(result.hasErrors()){
            ...
            return "redirect:http://auth.sukestore.com/reg.html";
        }
        // 开始注册 调用远程服务
        // 1.校验验证码
